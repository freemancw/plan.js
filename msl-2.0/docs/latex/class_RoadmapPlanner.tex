...
\label{class_RoadmapPlanner}\index{RoadmapPlanner@{Roadmap\-Planner}}
{\tt \#include $<$planner.h$>$}
...
\subsubsection{\setlength{\rightskip}{0pt plus 5cm}Roadmap\-Planner::Roadmap\-Planner ({\bf Problem} $\ast$ {\em problem})}\label{class_RoadmapPlanner_a0}
...
Reimplemented from {\bf Planner} {\rm (p.\,\pageref{class_Planner_a6})}.\index{RoadmapPlanner@{Roadmap\-Planner}!WriteGraphs@{WriteGraphs}}
