...
Implemented in {\bf Model3DRigid\-Helical} {\rm (p.\,\pageref{classModel3DRigidHelical_a3})}.\index{Model@{Model}!L@{L}}
...
Reimplemented in {\bf Model2DRigid} {\rm (p.\,\pageref{classModel2DRigid_a4})}.\index{Model@{Model}!Metric@{Metric}}
...
Reimplemented in {\bf Model2DPoint} {\rm (p.\,\pageref{classModel2DPoint_a4})}.\index{Model@{Model}!Partialf_u@{Partialf\_\-u}}
...
\index{Model@{Model}!PartialL_u@{PartialL\_\-u}}
...
Reimplemented in {\bf Model2DRigid\-Car\-Smooth} {\rm (p.\,\pageref{classModel2DRigidCarSmooth_a5})}.\index{Model@{Model}!StateDifference@{StateDifference}}
...
Reimplemented in {\bf Model2DRigid} {\rm (p.\,\pageref{classModel2DRigid_a5})}.\index{Model@{Model}!StateToConfiguration@{StateToConfiguration}}
...
Reimplemented in {\bf Model2D} {\rm (p.\,\pageref{classModel2D_a2})}.\index{Model@{Model}!StateTransitionEquation@{StateTransitionEquation}}
\index{StateTransitionEquation@{StateTransitionEquation}!Model@{Model}}
\subsubsection{\setlength{\rightskip}{0pt plus 5cm}virtual {\bf MSLVector} Model::State\-Transition\-Equation (const {\bf MSLVector} \& {\em x}, const {\bf MSLVector} \& {\em u})\hspace{0.3cm}{\tt  [pure virtual]}}\label{classModel_a3}
