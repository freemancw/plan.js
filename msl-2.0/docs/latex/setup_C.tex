...
\label{setup_C}\index{setup.C@{setup.C}}
...
\subsubsection{\setlength{\rightskip}{0pt plus 5cm}\#define MAKE\_\-MODEL(\_\-m)\ if (is\_\-file(path+\char`\"{}\char`\"{}\#\_\-m\char`\"{}\char`\"{})) m = new \_\-m(path);}\label{setup_C_a0}
...
\subsubsection{\setlength{\rightskip}{0pt plus 5cm}void Setup\-Problem ({\bf Model} $\ast$\& {\em m}, {\bf Geom} $\ast$\& {\em g}, string {\em path})}\label{setup_C_a2}
